(function ($) {
    ...
    p.getKnobStyle = function (knob) {
        ...
        var options = {width: Math.floor(holder.outerWidth()), height: Math.floor(holder.outerHeight()), fgColor: holder.css('color'), bgColor: holder.css('border-top-color'), draw: function () {
...
(function (namespace, $) {
    ...
    p.addCardLoader = function (card) {
        ...
        var opts = {lines: 17, length: 0, width: 3, radius: 6, corners: 1, rotate: 13, direction: 1, color: '#000', speed: 2, trail: 76, shadow: false, hwaccel: false, className: 'spinner', zIndex: 2e9};
...
(function (namespace, $) {
    ...
    p._initValidation = function () {
        ...
        $.validator.setDefaults({highlight: function (element) {
...
(function (namespace, $) {
    ...
    p._initSortables = function () {
        ...
        $('[data-sortable="true"]').sortable({placeholder: "ui-state-highlight", delay: 100, start: function (e, ui) {
